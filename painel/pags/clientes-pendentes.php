...
$query = "SELECT * FROM clientes_pendentes";
...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="../index.php">Usuários Pendentes</a>
            <!-- Form -->
            <!-- User -->
    ...
    <div class="header bg-gradient-crypto pb-8 pt-5 pt-md-8">
        <div class="container-fluid">
            <div class="header-body">
                <?php if (!empty($_GET["statusUPDT"])) {?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <span class="alert-inner--icon"><i class="ni ni-like-2"></i></span>
                        <span class="alert-inner--text"><strong>Sucesso!</strong> Update Realizado com Sucesso!</span>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                ...
                                                <a class="dropdown-item" href="addPlano.php?idUser=<?= $row['id_cliente'];?>&idPlano=<?= $row['id_plano'];?>&id=<?= $row['id'];?>">
                                                    Adicionar Plano</a>
                                            </div>
                                        </div>
                                    </td>
