...
$query = "SELECT * FROM clientes_ativos";
...
<body>
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
            <div class="container-fluid">
                <!-- Brand -->
                <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="../index.php">Usuários Ativos</a>
                <!-- Form -->
                <!-- User -->
                ...
                <div class="header-body">
                    <?php if (!empty($_GET["statusDel"])) {?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            <span class="alert-inner--text"><strong>Sucesso!</strong> Venda Deletada com Sucesso</span>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">Término do Plano</th>
                                    <th scope="col"></th>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <td>
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <span class="mb-0 text-sm"><?php echo $row['nome_cliente']?></span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                          <span class="badge badge-dot mr-4">
                                            <?php echo $row['nome_plano']?>
                                          </span>
                                    </td>
                                    <td>
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <span class="mb-0 text-sm"><?php echo $row['valor']?></span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <small><?php echo $row['data_adesao']?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <small><?php echo $row['data_exclusao']?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                ...
                                                <a class="dropdown-item" href="delete.php?del=<?= $row['id'];?>">
                                                    Excluir Usuario</a>
                                            </div>
                                        </div>
                                    </td>
